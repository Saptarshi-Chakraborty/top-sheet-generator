...
let makautRollField = document.getElementById('makautRoll');
...
f.addEventListener("submit", () => {
    ...
    // Version 19 on Nov 21, 6:39 PM
    const API = "https://script.google.com/macros/s/AKfycbzZXoda0jWeVzNfBMr-qrtU09Afh_6rKHm4m9DgVENESzay9AXLctvVdpvTlwP94vj1/exec";
    ...
    let primaryFormData = { mRoll, sName, sRoll, title, subject, sem, cName: "null" };
    ...
    fetch(API, params).then(res => res.text()).then((_data) => {
        ...
        if (status == "success") {
            ...
            cusromNameField.placeholder = "Default filename = Your Roll Number";
